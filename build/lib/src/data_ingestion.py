...
class DataIngestion:
    ...
    def download_csv_from_gcp(self):
        try:
            ...
            logger.info(f"CSV file is sucessfully downloaded to {RAW_FILE_PATH}")
    ...
    def split_data(self):
        try:
            ...
            raise CustomExeption("Failed to split data into train and test", e)
    ...
    def run(self):
        try:
            ...
            logger.info("Data ingestions completed sucessfully")

        except CustomExeption as ce:
            logger.error(f"CustomExeption : {str(ce)}")
